...
>
  ...
  <nav class="grid grid-cols-2 items-center py-1 md:hidden z-100">
  ...
  <div 
      x-show="open" 
      x-cloak 
      class="fixed inset-0 bg-opacity-60 bg-black/60 backdrop-blur-md text-white flex flex-col justify-center items-center z-50 transition duration-300 ease-in-out "
  >
