<footer class="text-white w-full text-center px-2 md:px-4 my-12 md:my-16">
    <h2 class="text-3xl md:text-6xl xl:text-7xl text-left max-w-5xl">For new business inquiries please email to <a href="mailto:veldwischthijs@gmail.com" class="text-neutral-400 underline hover:text-white trasistion ease-in-out duration-100">veldwischthijs@gmail.com</a></h2>
    <div class="grid grid-cols-1 md:grid-cols-2 mt-10 md:mt-20">
        ...
        <div 
          ...
          class="mr-6 text-left text-lg md:text-xl mt-4 md:mt-0"
        >
